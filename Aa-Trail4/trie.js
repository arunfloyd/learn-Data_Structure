...
class Trie {
  ...
  longestCommonPrefix() {
    ...
    while (true) {
       if (Object.keys(curr.children).length === 1 && !curr.isWordEnd) {
         prefix += Object.keys(curr.children)[0];
...
tries.insert("apple");
tries.insert("appldata");
tries.insert("applemon");
tries.insert("king");
console.log(tries.contains("apple"));
console.log("Longest common prefix:", tries.longestCommonPrefix());
